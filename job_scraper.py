...
# -*- coding: utf-8 -*-
"""
Created on Wed May 30 16:55:18 2023
...
def search(search_term, country, city, number_pages=10):
    ...
    -country: str, country code of indeed site e.g. "in" for India
    -city: str, city you want to search in e.g. "bangalore"
...
def write_data(city, search_term, extra_term=""):
    ...
    if extra_term == "":
        ...
        csv_filename = '/Users/AnudeepReddy/Documents/Job_Scraper/' + city + '_' + search_term + '_' + extra_term + '_' + current_date + '.csv'
        df.to_csv(csv_filename, index=False, header=True)
